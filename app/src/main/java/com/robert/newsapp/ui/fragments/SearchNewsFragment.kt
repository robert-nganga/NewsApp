...
import com.robert.newsapp.adapters.NewsAdapter
import com.robert.newsapp.ui.NewsActivity
import com.robert.newsapp.ui.NewsViewModel
import com.robert.newsapp.util.Constants
import com.robert.newsapp.util.Constants.Companion.SEARCH_NEWS_TIME_DELAY
...
class SearchNewsFragment : Fragment(R.layout.fragment_search_news) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        etSearch.addTextChangedListener { editable ->
            Log.i("SearchNewsFragment", "Searching for:: ${editable.toString()}")
            job?.cancel()
            ...
            when(response){
                is Resource.Success -> {
                    ...
                    response.data?.let { newsResponse ->
                        ...
                        Log.i("SearchNewsFragment", "Result returned again is:: ${newsResponse.articles[0].title}")
